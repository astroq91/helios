...
class basic_hashed_string : internal::basic_hashed_string<Char> {
  ...
  public:
    ...
    value(const value_type* str, const size_type len) noexcept {
    ...
    [[nodiscard]] static constexpr hash_type
    value(const value_type (&str)[N]) noexcept {
     ...
     */
    [[nodiscard]] static constexpr hash_type
    value(const_wrapper wrapper) noexcept {
...
operator==(const basic_hashed_string<Char>& lhs,

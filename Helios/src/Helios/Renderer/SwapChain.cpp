...
void SwapChain::init(bool vsync) {
    ...
    SwapchainSupportDetails swapchain_support =
        VulkanUtils::query_swapchain_support(context.physical_device,
                                             context.surface);

    m_surface_format =
        VulkanUtils::choose_swap_surface_format(swapchain_support.formats);
    m_present_mode = VulkanUtils::choose_swap_present_mode(
    ...
    QueueFamilyIndices indices = VulkanUtils::find_queue_families(
